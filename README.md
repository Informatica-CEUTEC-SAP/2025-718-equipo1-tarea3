...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p ce67fc79-45d4-4a79-8389-932fd0848545
```

> `ce67fc79-45d4-4a79-8389-932fd0848545` is the password of the certificate, you can change it to any password you want.
