...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 87fd91e5-cb02-4270-9f13-4da050ed9111
```

> `87fd91e5-cb02-4270-9f13-4da050ed9111` is the password of the certificate, you can change it to any password you want.
